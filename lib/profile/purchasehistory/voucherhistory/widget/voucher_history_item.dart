...
import 'package:hustle_house_flutter/model/voucher_history.dart';
...
class VoucherHistoryItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String? expired = DateFormat('dd MMMM yyyy')
        .format(voucherHistory!.expired ?? DateTime(2000));
    String? transactionDate = DateFormat('dd-MM-yyyy')
        .format(voucherHistory!.transactionDate ?? DateTime(2000));
    return InkWell(
      onTap: onTap,
      child: Stack(
        children: [
