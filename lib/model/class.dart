...
class SportClass {
  ...
  factory SportClass.fromJson(Map<String, dynamic> json) => SportClass(
    ...
    sportsClassImages: json["sportsClassImages"] == null ? [] : List<SportsClassImage>.from(json["sportsClassImages"]!.map((x) => SportsClassImage.fromJson(x))),
    sportsClassAsset: json["sportsClassAsset"] == null ? null : SportsClassAsset.fromJson(json["sportsClassAsset"]),
    sportsClassType: json["sportsClassType"] == null ? [] : List<SportsClassType>.from(json["sportsClassType"]!.map((x) => SportsClassType.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "sportsClassImages": sportsClassImages == null ? [] : List<dynamic>.from(sportsClassImages!.map((x) => x.toJson())),
    "sportsClassAsset": sportsClassAsset?.toJson(),
    "sportsClassType": sportsClassType == null ? [] : List<dynamic>.from(sportsClassType!.map((x) => x.toJson())),
  };
}
...
class SportsClassAsset {
  ...
  factory SportsClassAsset.fromJson(Map<String, dynamic> json) => SportsClassAsset(
    id: json["id"],
    logo: json["logo"],
...
class SportsClassImage {
  ...
  factory SportsClassImage.fromJson(Map<String, dynamic> json) => SportsClassImage(
    id: json["id"],
    image: json["image"],
    sportsClassId: json["sportsClassID"],
    imageUrl: json["imageUrl"],
