...
class BookingHistoryCancelled {
  ...
  factory BookingHistoryCancelled.fromRawJson(String str) =>
      BookingHistoryCancelled.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory BookingHistoryCancelled.fromJson(Map<String, dynamic> json) =>
      BookingHistoryCancelled(
