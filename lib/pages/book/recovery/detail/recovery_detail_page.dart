  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<RecoveryDetailController>(builder: (context) {
        ...
        var classDetail = controller.recovery.value;
        ...
        return Column(
          children: [
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          TitleDetailSection(
                              ...
                              isShowCredit: controller.isShowDetail(),
                          ...
                          Visibility(
                            ...
                            child: Container(
                              ...
                              child: TextBold(
                                text: controller.recovery.value
                                        ?.getDateSchedule() ??
                                    '',
                              ),
                            ),
                    ...
                    Visibility(
                      visible:
                          !controller.isCancelled() && !isFromBookingHistory,
                      child: Column(
                        children: [
                          Divider(
                            color: gray1,
                          ...
                          ExpandableDetailSection(
                            ...
                            description: sportClass?.cancellationPolicy ?? '',
            ...
            ButtonRecoverySection(
                title: title ?? '', name: sportClass?.name ?? '')
          ],
        );
      }),
    );
