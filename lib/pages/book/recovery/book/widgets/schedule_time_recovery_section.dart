                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ItemScheduleWellness(
                            name: key,
                            isSelected:
                                controller.currentSessionIndex.value == index,
                            onTap: () {
                              controller.updateSessionIndex(
                                  key, index, controller.getScheduleTimes());
                              controller.updateShowSession();
                    ...
                    firstChild: Container(
                      ...
                      child: ListView.separated(
                        ...
                        itemCount: controller
                                .getScheduleTimes()[controller.currentKey.value]
                                ?.length ??
                            0,
                        physics: const NeverScrollableScrollPhysics(),
                        itemBuilder: (context, index) {
                          final scheduleTime = controller.getScheduleTimes()[
