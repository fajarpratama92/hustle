                ...
                children: [
                  ...
                  Row(
                    children: [
                      MyCredit(
                        credit:
                            controller.trainer.value?.price.toString() ?? '0',
                      ),
                      const SizedBox(
                        width: 10,
                      ),
                      DisabledPointReward(
                        reward:
                            "+${controller.trainer.value?.rewardPoint ?? 0}",
                      )
                    ],
                  )
                ],
