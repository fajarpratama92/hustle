...
class CustomDialog {
  error(String errorMessage, {double? height}) {
  ...
  success(String message, VoidCallback onTap) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      insetPadding: EdgeInsets.symmetric(horizontal: 20, vertical: vertical),
            ...
            children: [
              ...
              Expanded(
                child: PrimaryButton(
                  ...
                  colorButton:
                      message.isNotEmpty ? Color(0xFFFF2E12) : primaryColor,
